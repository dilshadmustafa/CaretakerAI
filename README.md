...
>  - Develop Caretaker Software Architecture (CSA), a Software Approach with highly scalable Cluster Computing system that can be applied at very large scale and uses existing BigData `enter code here`systems like HDFS, Scality, Akka, Alluxio, HBase, Java, Clojure, etc.



## Documentation ##

Please refer ScabiAI.pptx in Documentation folder to get started on using Roy AI.
